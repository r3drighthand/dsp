...
I've got both Python versions 2.7.1 and 3.6.4 installed. Python 2 came pre-installed with my MacBook, and I installed Python 3 later. But Python 3 isn't backwards compatible with 2...
